...
<html lang="en">
<head>
    <title>Code coverage report for src/lexer.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/lexer.js</span></h1>
    <h2>
        Statements: <span class="metric">92.35% <small>(169 / 183)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">86.52% <small>(77 / 89)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(16 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.37% <small>(169 / 181)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; lexer.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">9644</span>
<span class="cline-any cline-yes">9644</span>
<span class="cline-any cline-yes">9644</span>
<span class="cline-any cline-yes">9644</span>
<span class="cline-any cline-yes">9644</span>
...
<span class="cline-any cline-yes">359</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9285</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9644</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2298</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2192</span>
<span class="cline-any cline-yes">2192</span>
...
<span class="cline-any cline-yes">17</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2175</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2192</span>
...
<span class="cline-any cline-yes">2398</span>
<span class="cline-any cline-yes">2398</span>
<span class="cline-any cline-yes">2391</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2396</span>
...
<span class="cline-any cline-yes">112</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3342</span>
...
<span class="cline-any cline-yes">85</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3257</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3342</span>
...
lexer.prototype.input = function(size) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ch) <span class="cstat-no" title="statement not covered" >return '';</span>
  this.yytext += ch;
  this.offset ++;
...
lexer.prototype.unput = function(size) {
  if (size === 1) {
    ...
    this.offset --;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._input[this.offset] === '\n' &amp;&amp; this._input[this.offset - 1] === '\r') {
...
<span class="cstat-no" title="statement not covered" >      size ++;</span>
    ...
    this.offset -= size;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (size &lt; this.yytext.length) {
      this.yytext = this.yytext.substring(0, this.yytext.length - size);
      ...
      for(var i = 0; i &lt; this.yytext.length; i++) {
        ...
        if (c === '\r') {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (c !== '\n') {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (c === '\r') {
...
<span class="cstat-no" title="statement not covered" >          this.yyprevcol = this.yylloc.last_column;</span>
<span class="cstat-no" title="statement not covered" >          this.yylloc.last_line ++;</span>
<span class="cstat-no" title="statement not covered" >          this.yylloc.last_column = 0;</span>
        } else {
          this.yylloc.last_column ++;
        }
      }
...
<span class="cstat-no" title="statement not covered" >      this.yylloc.last_line = this.yylineno = this.yylloc.first_line;</span>
<span class="cstat-no" title="statement not covered" >      this.yylloc.last_column = this.yylloc.first_column;</span>
    }
  }
&nbsp;
  return this;
...
lexer.prototype.ahead = function(size) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (text[text.length - 1] === '\r' &amp;&amp; this._input[this.offset + size + 1] === '\n') {
...
lexer.prototype.consume = function(size) {
  for(var i = 0; i &lt; size; i++) {
    var ch = this._input[this.offset];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ch) <span class="cstat-no" title="statement not covered" >break;</span>
    this.yytext += ch;
    this.offset ++;
    if ( ch === '\r' &amp;&amp; this._input[this.offset] === '\n' ) {
      this.yytext += '\n';
...
lexer.prototype.lex = function() {
  ...
  if (!this.all_tokens) {
    while(
      ...
      token = this.next() || <span class="branch-1 cbranch-no" title="branch not covered" >this.lex();</span>
    }
...
lexer.prototype.begin = function(condition) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.stateCb !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw new Error('Undefined condition state "'+condition+'"');</span>
  }
  return this;
};
&nbsp;
...
lexer.prototype.popState = function() {
  ...
  var condition = (n &gt; 0) ? this.conditionStack.pop() : <span class="branch-1 cbranch-no" title="branch not covered" >this.conditionStack[0];</span>
  this.curCondition = this.conditionStack[this.conditionStack.length - 1];
  this.stateCb = this['match' + this.curCondition];
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof this.stateCb !== 'function') {
<span class="cstat-no" title="statement not covered" >    throw new Error('Undefined condition state "'+this.curCondition+'"');</span>
  }
  return condition;
};
&nbsp;
