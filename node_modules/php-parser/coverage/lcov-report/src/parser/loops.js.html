...
<html lang="en">
<head>
    <title>Code coverage report for src/parser/loops.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/parser/loops.js</span></h1>
    <h2>
        Statements: <span class="metric">100% <small>(74 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">70% <small>(35 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(5 / 5)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(61 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/parser/</a> &#187; loops.js</div>
</div>
<div class="body">
...
module.exports = {
  ...
  ,read_do: function() {
    ...
    ;
    body = this.read_statement();
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.expect(this.tok.T_WHILE)) {
  ...
  ,read_foreach: function() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.expect(this.tok.T_AS)) {
      this.next();
