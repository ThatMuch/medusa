...
<html lang="en">
<head>
    <title>Code coverage report for src/parser/statement.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/parser/statement.js</span></h1>
    <h2>
        Statements: <span class="metric">88.4% <small>(160 / 181)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">84.13% <small>(106 / 126)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(9 / 9)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">89.33% <small>(159 / 178)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/parser/</a> &#187; statement.js</div>
</div>
<div class="body">
...
module.exports = {
  ...
  read_top_statements: function() {
    ...
    while(this.token !== this.EOF &amp;&amp; this.token !== '}') {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (statement) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(statement)) {
<span class="cstat-no" title="statement not covered" >          result = result.concat(statement);</span>
        } else {
...
<span class="branch-8 cbranch-no" title="branch not covered" >      case this.tok.T_NAMESPACE:</span>
<span class="cstat-no" title="statement not covered" >        return this.read_namespace();</span>
      case this.tok.T_HALT_COMPILER:
        var result = this.node('halt');
        if (this.next().expect('(')) <span class="cstat-no" title="statement not covered" >this.next();</span>
<span class="cstat-no" title="statement not covered" >        if (this.expect(')')) <span class="cstat-no" title="statement not covered" >this.next();</span></span>
<span class="cstat-no" title="statement not covered" >        this.expect(';');</span>
<span class="cstat-no" title="statement not covered" >        this.lexer.done = true;</span>
<span class="cstat-no" title="statement not covered" >        return result(this.lexer._input.substring(</span>
          this.lexer.offset
        ));
      default:
...
<span class="cstat-no" title="statement not covered" >          result = result.concat(statement);</span>
  ...
  ,read_const_list: function() {
    var result = this.read_list(function() {
      ...
      var name = this.text();
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.next().expect('=')) {
        return result(name, this.next().read_expr());
      } else {
        // fallback
<span class="cstat-no" title="statement not covered" >        return result(name, null);</span>
      }
    }, ',', false);
...
<span class="cstat-no" title="statement not covered" >        result[name] = null;</span>
      }
      if (this.token !== ',') break;
      this.next();
    }
  ...
  ,read_inner_statement: function() {
    switch(this.token) {
      ...
      case this.tok.T_FINAL:
        var flag = this.read_class_scope();
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.token === this.tok.T_CLASS) {
          return this.read_class(flag);
        } else {
<span class="cstat-no" title="statement not covered" >          this.error(this.tok.T_CLASS);</span>
...
<span class="cstat-no" title="statement not covered" >          return null;</span>
      ...
      case this.tok.T_TRAIT:
        return this.read_trait();
<span class="branch-6 cbranch-no" title="branch not covered" >      case this.tok.T_HALT_COMPILER:</span>
<span class="cstat-no" title="statement not covered" >        this.raiseError(</span>
          '__HALT_COMPILER() can only be used from the outermost scope'
        );
        // fallback : returns a node but does not stop the parsing
<span class="cstat-no" title="statement not covered" >        var node = this.node('halt');</span>
<span class="cstat-no" title="statement not covered" >        this.next().expect('(') &amp;&amp; this.next();</span>
<span class="cstat-no" title="statement not covered" >        this.expect(')') &amp;&amp; this.next();</span>
<span class="cstat-no" title="statement not covered" >        node = node(this.lexer._input.substring(</span>
          this.lexer.offset
        ));
<span class="cstat-no" title="statement not covered" >        this.expect(';') &amp;&amp; this.next();</span>
...
&nbsp;
      case this.tok.T_GOTO:
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.next().expect(this.tok.T_STRING)) {
          label = this.text();
