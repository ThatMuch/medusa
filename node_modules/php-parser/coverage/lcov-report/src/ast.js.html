...
<html lang="en">
<head>
    <title>Code coverage report for src/ast.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ast.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; ast.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2628</span>
<span class="cline-any cline-yes">2628</span>
<span class="cline-any cline-yes">58</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2628</span>
...
AST.prototype.prepare = function(kind, parser) {
  ...
  return function() {
    ...
    if (self.withPositions || self.withSource) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (self.withPositions) {
...
<span class="cstat-no" title="statement not covered" >        location = new Location(src, null, null);</span>
      }
    ...
    // build the object
    var node = self[kind];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof node !== 'function') {
<span class="cstat-no" title="statement not covered" >      throw new Error('Undefined node "'+kind+'"');</span>
    }
